...
public class SiteBean implements Serializable {
    ...
    private List<String> modules = Arrays.asList("news", "person");
    private String serverName = "localhost";

    private String siteKey = "myCustomSite";

    private String templateSet = "dx-base-demo-templates";

    private String title = "My Custom Site";
    ...
    public void validateCreateSite(ValidationContext context) {
        ...
        String siteTheme = (String) context.getUserValue("siteTheme");
        String siteType = (String) context.getUserValue("siteType");
        ...
        try {
            ...
            if (siteTheme == null){
                messages.addMessage(new MessageBuilder().error().source("siteTheme")
                        .code("serverSettings.manageWebProjects.warningMsg.completeRequestInfo").build());
            }

            if (siteType == null){
                messages.addMessage(new MessageBuilder().error().source("siteType")
                        .code("serverSettings.manageWebProjects.warningMsg.completeRequestInfo").build());
            }
